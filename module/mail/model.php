<?php
/**
 * The model file of mail module of xirangEPS.
 *
...
class mailModel extends model
{
    ...
    public function setMTA()
    {
        ...
        if(!method_exists($this, $funcName)) echo $this->app->triggerError("The MTA {$this->config->mail->mta} not supported now.", __FILE__, __LINE__, $exit = false);
        $this->$funcName();
    }
     ...
     * Send a email.
     * 
     * @param string $toList    the to addresses
     * @param string $subject   the subject
     * @param string $body      the email body
     * @param string $ccList    the cc addresses
     * @access public
     * @return void
     */
    ...
    /**
     * Clear the addresses and attachments.
     * 
     * @access private
     * @return void
     */
