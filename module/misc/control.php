<?php
/**
 * The control file of misc of XiRangBPS.
 *
...
class misc extends control
{
    ...
    public function fixComment()
    {
        ...
        $modules = $this->dao->select('id')->from(TABLE_MODULE)->where('tree')->in(array('zentaopmshelp', 'XiRangBPShelp'))->fetchpairs('id', 'id', false);
