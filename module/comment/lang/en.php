<?php
/**
 * The comment module English file of xirangEPS.
 *
...
$lang->comment->manage       = 'Manage comment';
...
$lang->comment->securityCode = 'Auth-code';
...
$lang->comment->reviewed            = 'Reviewed';
$lang->comment->unReviewed          = 'Unreviewed';

$lang->securityCode->numbers = array('zero', 'one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten');
$lang->securityCode->actions = array('*' => 'Ｘ', '-' => '－', '+' => '＋');
$lang->securityCode->equal   = 'equal';
$lang->securityCode->notice  = '(fill number)';
