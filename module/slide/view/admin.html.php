...
<form id='sortForm' action='<?php echo inLink('sort')?>' method='post'>
  <table class="table table-hover table-bordered table-striped">
    <caption>
      ...
      <div class='f-right'><?php echo html::a($this->inlink('create'), $lang->slide->create, '', "data-toggle='modal' data-width='800px;'");?></div>
    </caption>
    <thead>
      <tr class='a-center'>
        ...
        <th class="w-200px"><?php echo $lang->slide->summary;?></th>
        <th class="w-60px"><?php echo $lang->slide->label;?></th>
    ...
    <tbody>
      ...
      <tr class='a-left v-middle'>
        ...
        <td class='a-center'>
          <?php
          echo html::a($this->createLink('slide', 'edit', "id=$slide->id"), $lang->edit, '', "data-toggle='modal'");
