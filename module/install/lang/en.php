<?php
/**
 * The install module English file of XiRangBPS.
 *
...
$lang->install->welcome          = 'Welcome to use XiRangBPS.';
$lang->install->desc             = <<<EOT
XiRangBPS is an content management software.

XiRangBPS is developped by PHH and mysql under the XiRangBPS framework developped by the same team. Through the framework, XiRangBPS can be customed and extended very easily.

XiRangBPS is developped by <strong class='red'><a href='http://www.cnezsoft.com' target='_blank'>Nature EasySoft Network Tecnology Co.ltd, QingDao, China</a></strong>。
The official website of XiRangBPS is <a href='http://www.xirang.biz' target='_blank'>http://www.xirang.biz</a>
...
$lang->install->webRoot      = 'XiRangBPS path';
