  ...
  <div class='u-1'>
    <table class='table-1'>
      <caption class='caption-bold'>
        ...
        <div class='f-right'><?php if(!$board->readonly) echo html::a($this->createLink('thread', 'post', "boardID=$board->id"), $lang->forum->post, '', "style='color:#FF0'");?></div>
      </caption>
      <tr>
    ...
    <div class='a-center f-16px post-thread <?php if($this->cookie->lang == 'en') echo 'en-post-thread'?>'><?php echo html::linkButton('', $this->createLink('thread', 'post', "boardID=$board->id"));?></div>
  </div>
</div>
