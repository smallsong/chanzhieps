<?php
/**
 * The thread module english file of XiRangBPS.
 *
...
$lang->thread->lblUser   = '<strong>%s</strong><br />Views: %s<br />Register: %s<br />Last visits: %s<br />Score: %s';
...
$lang->reply->addedDate = 'Reply date ';
$lang->reply->toAsk     = 'This post has been into question, <a href="/ask-view-%s">View question</a>';
