  ...
  <table class='table-1' align='center'>
    ...
    <tr>
     <td class='a-center' id='basic'>
       ...
       echo '<p>' . html::a($this->createLink('ask', 'manageAnswers'), $lang->admin->manageAnswers, 'mainwin') . '</p>';
       echo '<p>' . html::a($this->createLink('forum', 'updateStats'), $lang->admin->updateForum, 'mainwin') . '</p>';
       echo '<p>' . html::a($this->createLink('user', 'forbid'), $lang->admin->forbidUser, 'mainwin') . '</p>';
       ?>
     </td>
    </tr>
  </table>
