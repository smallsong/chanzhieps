...
<frameset rows='20, *' framespacing='0' frameborder='0'>
  ...
  <frameset cols='200, *' framespacing='0' frameborder='0'>
    <frame src='<?php echo inlink('leftmenu', 'tree=rssarticle');?>' scrolling='auto' name='leftwin'>
    <frame src='<?php echo $this->createLink('rssarticle', 'review');?>' name='mainwin' id='mainwin' scrolling='yes'>
  </frameset>
</frameset>
</html>
